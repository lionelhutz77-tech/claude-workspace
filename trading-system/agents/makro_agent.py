...
MAKRO_EVENTS = {
    ...
    "zinssenkung": {
        ...
        "negativ_assets": ["JPM", "BAC", "GS"],
        "positiv_assets": ["BTC", "ETH", "TSLA", "NVDA", "META", "growth"],
        "staerke": +3,
    ...
    "krieg_konflikt": {
        ...
        "negativ_assets": ["BTC", "ETH", "TSLA", "growth", "SPY", "market"],
        "positiv_assets": ["GOLD", "XOM", "CVX", "LMT", "NOC", "GD", "RTX"],
        "staerke": -2,
    ...
    "deeskalation": {
        ...
        "negativ_assets": ["GOLD", "LMT", "NOC", "GD", "RTX"],
        "positiv_assets": ["BTC", "ETH", "growth", "SPY", "DAL", "UAL", "AAL"],
        "staerke": +2,
    ...
    "oelpreis_crash": {
        ...
        "positiv_assets": ["DAL", "UAL", "AAL", "FDX", "UPS", "AMZN", "consumer"],
        "staerke": -2,
        "beschreibung": "Oelpreiscrash — Energieaktien fallen, Transport/Konsum profitieren",
    },
    "oelpreis_anstieg": {
        ...
        "negativ_assets": ["DAL", "UAL", "AAL", "FDX", "consumer", "AMZN"],
        "positiv_assets": ["XOM", "CVX", "COP", "BP", "SLB", "GOLD"],
        "staerke": -1,
        "beschreibung": "Oelpreisanstieg — Energiekosten steigen, Transport leidet",
    },
    ...
    "rezession": {
        ...
        "negativ_assets": ["TSLA", "AMZN", "HD", "LOW", "BTC", "growth"],
        "positiv_assets": ["WMT", "COST", "JNJ", "PG", "KO", "GOLD"],
        "staerke": -3,
    ...
    "starke_wirtschaft": {
        ...
        "negativ_assets": [],
        "positiv_assets": ["SPY", "growth", "AMZN", "HD", "TSLA"],
        "staerke": +2,
        "beschreibung": "Starke Wirtschaft — Konsumwerte und Zykliker profitieren",
    },
}
